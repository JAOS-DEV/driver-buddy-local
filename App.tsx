...
const App: React.FC = () => {
  ...
  return (
    <div className="min-h-screen w-full flex items-center justify-center bg-[#FAF7F0] p-4 overflow-hidden">
      ...
      <div className="w-full max-w-sm h-screen sm:h-[700px] sm:max-w-md bg-[#FAF7F0] sm:rounded-3xl sm:shadow-2xl sm:border sm:border-slate-200/50 flex flex-col overflow-hidden mx-auto">
